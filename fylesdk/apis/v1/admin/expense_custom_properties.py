...
class ExpenseCustomProperties(ApiBase):
    ...
    GET_EXPENSE_CUSTOM_PROPERTIES = '/expense_custom_properties'

    def __init__(self, version, role):
        super().__init__(version, role)

    def get(self, created_at=None, updated_at=None, name=None, only_enabled=None,
        ...
        return self.make_get_request(
            api_url=ExpenseCustomProperties.GET_EXPENSE_CUSTOM_PROPERTIES,
            query_params={
